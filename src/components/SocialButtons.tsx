        ...
        >
          ...
          >
            ...
            <div
              className={`
                ...
                ${hoveredIndex === index ? "opacity-100 scale-125" : ""}
              `}
            />
            ...
            <div
              className={`
                ...
                ${hoveredIndex === index ? "opacity-100 scale-150" : ""}
              `}
            />
          ...
          <div
            className={`
              ...
              px-3 py-1.5 rounded-lg bg-primary text-primary-foreground text-sm font-medium
