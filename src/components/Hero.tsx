    ...
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      >
        <img 
          ...
          style={{ transform: isMobile ? 'none' : 'scale(1.1)' }}
        />
      ...
      >
        <div className="max-w-4xl mx-4 md:mx-[20px] px-4 md:px-[30px]">
          ...
          <h1 className={`font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-primary-foreground leading-[1.05] mb-6 md:mb-8 transition-all duration-700 delay-100 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            Elevate Your Space
          ...
          <p className={`text-primary-foreground/85 text-lg md:text-xl lg:text-2xl mb-8 md:mb-10 leading-relaxed font-light max-w-2xl transition-all duration-700 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <div className={`flex flex-wrap items-center gap-6 md:gap-8 transition-all duration-700 delay-400 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            ...
            <div className="text-primary-foreground/80">
              ...
              <div className="text-xs md:text-sm text-primary-foreground/60">Trusted by luxury homeowners worldwide</div>
            </div>
          </div>
        </div>
      </div>
