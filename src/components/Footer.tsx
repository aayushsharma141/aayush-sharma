...
const Footer = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,hsl(0_0%_100%/0.05)_0%,transparent_50%)]" />
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-3">
              ...
              <span className="font-serif text-2xl font-bold">
                <span className="text-primary-foreground">Crossangle</span>{" "}
                <span className="text-primary-foreground/80">Interior</span>
              </span>
            </Link>
            <p className="text-primary-foreground/80 mt-4 mb-6">
              Transforming your vision into exquisite living spaces with innovative and personalized interior design solutions.
            </p>
            
            <div className="space-y-3 text-sm">
              <a href="tel:+917909041132" className="flex items-center gap-2 text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                <Phone className="w-4 h-4" />
                <span>+91 7909041132</span>
              </a>
              <a href="tel:+919304853659" className="flex items-center gap-2 text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                <Phone className="w-4 h-4" />
                <span>+91 9304853659</span>
              </a>
              <a href="mailto:info@crossangleinterior.com" className="flex items-center gap-2 text-primary-foreground/80 hover:text-primary-foreground transition-colors">
            ...
            <div className="flex gap-3 mb-6">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className="w-10 h-10 bg-primary-foreground/10 border border-primary-foreground/20 rounded-full flex items-center justify-center hover:bg-primary-foreground hover:text-primary transition-colors duration-300"
                >
                  <social.icon className="w-5 h-5" />
                </a>
              ))}
            </div>
            <div className="bg-primary-foreground/10 border border-primary-foreground/20 p-4 rounded-lg">
