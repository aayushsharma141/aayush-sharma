    ...
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      >
        <div className="max-w-4xl mx-4 md:mx-[20px] px-4 md:px-[30px]">
          ...
          <h1
            className={`font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-primary-foreground leading-[1.05] mb-6 md:mb-8 transition-all duration-700 delay-100 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
          ...
          <p
            className={`text-primary-foreground/85 text-lg md:text-xl lg:text-2xl mb-8 md:mb-10 leading-relaxed font-light max-w-2xl transition-all duration-700 delay-200 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
