          ...
          <SidebarContent>
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-bold text-lg text-gray-900">Crossangle Interior</h2>
                  ...
                  {section.collapsible ? (
                    ...
                    >
                      <CollapsibleTrigger className="w-full">
                        <SidebarGroupLabel className="flex items-center justify-between hover:bg-gray-100 rounded-md px-2 py-1.5 cursor-pointer transition-colors">
            ...
            <div className="border-t border-gray-200 p-4 space-y-2">
              <Button variant="outline" className="w-full justify-start hover:bg-gray-100 border-gray-300" asChild>
                <Link to="/">
          ...
          <header className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Manage your interior design website content</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
